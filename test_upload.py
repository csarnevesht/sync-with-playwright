...
def upload_single_file(page, file_to_upload, expected_items=1, max_tries=3):
    """
...
def upload_files_for_account(page, account, debug_mode=True):
    """
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for file_path in files_to_upload:
            ...
            # Upload single file
            if not upload_single_file(page, file_path, expected_items):
                upload_success = False
