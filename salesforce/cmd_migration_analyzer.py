...
Usage Examples:
    ...
    python -m salesforce.cmd_migration_analyzer --dropbox-account-name="Alexander & Armelia Rolle"

    # Process multiple accounts from a file
    python -m salesforce.cmd_migration_analyzer --dropbox-accounts-file=accounts/fuzzy.txt
